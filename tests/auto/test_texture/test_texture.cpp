...
void TestTexture::construct_data()
{
    ...
    QTest::newRow("ARGB32, 1x1x1, levels=1, layers=1")
            << Texture::Type::Texture1D << Texture::Format::RGBA_8888 // type / format
            << 1 << 1 << 1 // width / height / depth
            << 1 << 1 // levels / layers
            << qsizetype(4); // result
    QTest::newRow("ARGB32, 64x1x1, levels=1, layers=1")
            << Texture::Type::Texture1D << Texture::Format::RGBA_8888
            << 64 << 1 << 1
            << 1 << 1
            << qsizetype(256);
    ...
    // 1D texture array
    QTest::newRow("ARGB32, 100x1x1, levels=1, layers=1")
            << Texture::Type::Texture1DArray << Texture::Format::RGBA_8888
            << 100 << 1 << 1
            << 1 << 1
            << qsizetype(400);
    ...
    // 2D texture
    QTest::newRow("ARGB32, 1x1x1, levels=1, layers=1")
            << Texture::Type::Texture2D << Texture::Format::RGBA_8888
            << 1 << 1 << 1
            << 1 << 1
            << qsizetype(4);
    ...
    // 2D array
    QTest::newRow("ARGB32, 100x100x1, levels=1, layers=1")
            << Texture::Type::Texture2DArray << Texture::Format::RGBA_8888
            << 100 << 100 << 1
            << 1 << 1
            << qsizetype(40000);
    ...
    QTest::newRow("ARGB32, 64x64x64, levels=1, layers=1")
            << Texture::Type::Texture3D << Texture::Format::RGBA_8888
            << 64 << 64 << 64
            << 1 << 1
            << qsizetype(1048576);
    ...
    QTest::newRow("ARGB32, size=1, levels=1, layers=1")
            << Texture::Type::TextureCubeMap << Texture::Format::RGBA_8888
            << 1 << 1 << 1
            << 1 << 1
            << qsizetype(24);
    ...
    // CubeMap Array
    QTest::newRow("ARGB32, size=64, levels=1, layers=1")
            << Texture::Type::TextureCubeMapArray << Texture::Format::RGBA_8888
            << 64 << 64 << 1
            << 1 << 1
            << qsizetype(98304);
