...
constexpr TexelFormat formats[] = {
    ...
    {Texture::Format::BC1_RGB_SRGB, 0, 8, QOpenGLTexture::QOpenGLTexture::SRGB_DXT1},
    {Texture::Format::BC1_RGBA_Unorm, 0, 8, QOpenGLTexture::QOpenGLTexture::RGBA_DXT1},
    {Texture::Format::BC1_RGBA_SRGB, 0, 8, QOpenGLTexture::QOpenGLTexture::SRGB_Alpha_DXT1},
    {Texture::Format::BC2_Unorm, 0, 16, QOpenGLTexture::QOpenGLTexture::RGBA_DXT3},
    {Texture::Format::BC2_SRGB, 0, 16, QOpenGLTexture::QOpenGLTexture::SRGB_Alpha_DXT3},
    {Texture::Format::BC3_Unorm, 0, 16, QOpenGLTexture::QOpenGLTexture::RGBA_DXT5},
    {Texture::Format::BC3_SRGB, 0, 16, QOpenGLTexture::QOpenGLTexture::SRGB_Alpha_DXT5},
