...
static constexpr const TexelFormat formats[] = {
    ...
    {Texture::Format::BGRA_10101002_Rev, 32, 0, QOpenGLTexture::RGBA8_UNorm, QOpenGLTexture::BGRA, QOpenGLTexture::UInt32_RGB10A2_Rev},
    {Texture::Format::RGBA_10101002_Rev, 32, 0, QOpenGLTexture::RGBA8_UNorm, QOpenGLTexture::RGBA, QOpenGLTexture::UInt32_RGB10A2_Rev},
    // unsigned 24bit
