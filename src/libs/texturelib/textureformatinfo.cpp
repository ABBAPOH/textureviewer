...
constexpr TextureFormatInfo formats[] = {
    ...
    { TextureFormat::R16F,     16, 0, QOpenGLTexture::R16F,      QOpenGLTexture::Red,         QOpenGLTexture::Float16 },

    { TextureFormat::RG8Snorm, 16, 0, QOpenGLTexture::RG8_SNorm, QOpenGLTexture::RG,         QOpenGLTexture::Int8  },
    { TextureFormat::RG8Unorm, 16, 0, QOpenGLTexture::RG8_UNorm, QOpenGLTexture::RG,         QOpenGLTexture::UInt8 },
    { TextureFormat::RG8Sint,  16, 0, QOpenGLTexture::RG16I,     QOpenGLTexture::RG_Integer, QOpenGLTexture::Int8  },
    { TextureFormat::RG8Uint,  16, 0, QOpenGLTexture::RG16U,     QOpenGLTexture::RG_Integer, QOpenGLTexture::UInt8 },
    ...
    // 32bit
    { TextureFormat::R32Sint, 32, 0, QOpenGLTexture::R32I, QOpenGLTexture::Red_Integer, QOpenGLTexture::Int32   },
    ...
    { TextureFormat::RGBA8Uint,  32, 0, QOpenGLTexture::RGBA8U,       QOpenGLTexture::RGBA, QOpenGLTexture::UInt8 },
    { TextureFormat::RGBA8Srgb,  32, 0, QOpenGLTexture::SRGB8_Alpha8, QOpenGLTexture::RGBA, QOpenGLTexture::UInt8 },
    ...
    // 64bit
    { TextureFormat::RGBA16Snorm, 64, 0, QOpenGLTexture::RGBA16_SNorm, QOpenGLTexture::RGBA, QOpenGLTexture::Int16  },
    { TextureFormat::RGBA16Unorm, 64, 0, QOpenGLTexture::RGBA16_UNorm, QOpenGLTexture::RGBA, QOpenGLTexture::UInt16 },
    { TextureFormat::RGBA16Sint,  64, 0, QOpenGLTexture::RGBA16I,      QOpenGLTexture::RGBA, QOpenGLTexture::Int16  },
    { TextureFormat::RGBA16Uint,  64, 0, QOpenGLTexture::RGBA16U,      QOpenGLTexture::RGBA, QOpenGLTexture::UInt16 },
    { TextureFormat::RGBA16F,     64, 0, QOpenGLTexture::RGBA16F,      QOpenGLTexture::RGBA, QOpenGLTexture::Float16 },

    { TextureFormat::RG32Sint,  64, 0, QOpenGLTexture::RG32I, QOpenGLTexture::RG_Integer, QOpenGLTexture::Int32   },
    ...
    { TextureFormat::RGBA32F,    128, 0, QOpenGLTexture::RGBA32F, QOpenGLTexture::RGBA,         QOpenGLTexture::Float32 },
    ...
    // compressed
    { TextureFormat::Bc1RgbUnorm,  0,  8, QOpenGLTexture::RGB_DXT1              },
    { TextureFormat::Bc1RgbSrgb,   0,  8, QOpenGLTexture::SRGB_DXT1             },
    { TextureFormat::Bc1RgbaUnorm, 0,  8, QOpenGLTexture::RGBA_DXT1             },
    { TextureFormat::Bc1RgbaSrgb,  0,  8, QOpenGLTexture::SRGB_Alpha_DXT1       },
    { TextureFormat::Bc2Unorm,     0, 16, QOpenGLTexture::RGBA_DXT3             },
    { TextureFormat::Bc2Srgb,      0, 16, QOpenGLTexture::SRGB_Alpha_DXT3       },
    { TextureFormat::Bc3Unorm,     0, 16, QOpenGLTexture::RGBA_DXT5             },
    { TextureFormat::Bc3Srgb,      0, 16, QOpenGLTexture::SRGB_Alpha_DXT5       },
    { TextureFormat::Bc4Snorm,     0,  8, QOpenGLTexture::R_ATI1N_SNorm         },
    { TextureFormat::Bc4Unorm,     0,  8, QOpenGLTexture::R_ATI1N_UNorm         },
    { TextureFormat::Bc5Unorm,     0, 16, QOpenGLTexture::RG_ATI2N_UNorm        },
    { TextureFormat::Bc5Snorm,     0, 16, QOpenGLTexture::RG_ATI2N_SNorm        },
    ...
    { TextureFormat::Bc7Unorm,     0, 16, QOpenGLTexture::RGB_BP_UNorm          },
    { TextureFormat::Bc7Srgb,      0, 16, QOpenGLTexture::SRGB_BP_UNorm         },
